    ...
    return (
        <div className="bg-white my-7 border rounded-sm">
            ...
            <div className="flex items-center p-5">
                <img src={userImg} className="h-12 w-12 object-contain border p-1 mr-3 rounded-full" />
                ...
                <div className="ml-10 h-20 overflow-y-scroll scrollbar-thumb-black scrollbar-thin">
                    {comments.map(comment => (
                        <div key={comment.id} className="flex items-center space-x-2 mb-3">
                            ...
                            <p className="text-sm flex-1"><span className="font-bold p-1">{comment.data().username}</span>{comment.data().comment}</p>
            ...
            <form className="flex items-center p-4">
                ...
                className="border-[0.5px] border-gray-100 flex-1 focus:ring-0 outline-none rounded-r-full rounded-l-full border-1 m-2" 
