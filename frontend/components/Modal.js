            ...
            >
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        ...
                        px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all 
                            ...
                            <div>
                                ...
                                <div>
                                    <div className='mt-3 text-center sm:mt-5'>
                                        <Dialog.Title as='h3' className='text-lg leading-6 font-medium'>Upload a Pic</Dialog.Title>
                                    </div>
                                    <div>
                                        <input
                                            ref={filePickerRef}
                                    ...
                                    <div className='mt-2'>
                                        <input
                                            ...
                                            ref={captionRef}
                                            className='border-none text-center w-full focus:ring-0'
                                        />
                                    </div>
                                </div>
